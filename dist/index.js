...
(function (global, factory) {
  ...
  var Contour = /** @class */ (function () {
       ...
       */
      Contour.tracingContourLines = function (S0, X, Y, nc, contour, undefData, borders, S1) {
          var contourLines = Contour.createContourLines_UndefData(S0, X, Y, nc, contour, S1, undefData, borders);
          return contourLines;
      };
      //    /**
      //     * Tracing contour lines from the grid data with undefine data
       ...
       */
      Contour.tracingBorders = function (S0, X, Y, S1, undefData) {
          var borderLines = [];
          var m, n, i, j;
          m = S0.length; //Y
          n = S0[0].length; //X
       ...
       * @return contour line list
       */
      Contour.createContourLines_UndefData = function (S0, X, Y, nc, contour, S1, undefData, borders) {
          var contourLineList = [];
          var cLineList;
          var m, n, i, j;
          m = S0.length; //---- Y
       ...
       */
      Contour.pointInPolygonByPList = function (poly, aPoint) {
      ...
      Contour.pointInPolygon = function (aPolygon, aPoint) {
          if (aPolygon.hasHoles()) {
              var isIn = Contour.pointInPolygonByPList(aPolygon.outLine.pointList, aPoint);
              if (isIn) {
      ...
      Contour.traceBorder = function (S1, i1, i2, j1, j2, ij3) {
          var canTrace = true;
          var a, b, c, d;
          if (i1 < i2) {
              //---- Trace from bottom
      ...
      Contour.addHoles_Ring = function (polygonList, holeList) {
          ...
          for (i = 0; i < holeList.length; i++) {
              ...
              var aExtent = Contour.getExtent(holePs);
      ...
      Contour.cutPolyline = function (inPolyline, clipPList) {
          ...
          var plExtent = Contour.getExtent(aPList);
          var cutExtent = Contour.getExtent(clipPList);
          ...
          //Cutting
          var isInPolygon = Contour.pointInPolygonByPList(clipPList, aPList[0]);
          var q1, q2, p1, p2, IPoint;
          var lineA, lineB;
          var newPlist = [];
          var bLine;
      ...
      Contour.getExtent = function (pList) {
      ...
      Contour.getExtentAndArea = function (pList, aExtent) {
       ...
       */
      Contour.isClockwise = function (pointList) {
          var i;
          var aPoint;
          var yMax = 0;
          var yMaxIdx = 0;
      ...
      Contour.isLineSegmentCross = function (lineA, lineB) {
          ...
          if (!Contour.isExtentCross(boundA, boundB)) {
              ...
              var XP1 = (lineB.P1.x - lineA.P1.x) * (lineA.P2.y - lineA.P1.y) - (lineA.P2.x - lineA.P1.x) * (lineB.P1.y - lineA.P1.y);
              var XP2 = (lineB.P2.x - lineA.P1.x) * (lineA.P2.y - lineA.P1.y) - (lineA.P2.x - lineA.P1.x) * (lineB.P2.y - lineA.P1.y);
              if (XP1 * XP2 > 0) {
                  return false;
              }
              else {
      ...
      Contour.isExtentCross = function (aBound, bBound) {
      ...
      Contour.doubleEquals = function (a, b) {
